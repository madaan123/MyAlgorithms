...
/*  we have a array consisting of all zeroes
	we can only perform 2 operations in this array
	we can choose an elment and add 1 to it and operation count is 1
	we can multiply all elements of the array by 2 and operation count is 1
	we have to find minimum number of operations to convert the given array to required array
*/
